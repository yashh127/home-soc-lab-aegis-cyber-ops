...
export default function Header({ 
  ...
  return (
    <header className="cyber-card p-4 mb-5 flex flex-wrap items-center justify-between gap-4 border-b border-purple-500/20 relative z-30">
      {/* Left: Brand & Subtitle */}
      <div className="flex items-center gap-3.5 shrink-0">
        <div className="p-3 rounded-xl bg-gradient-to-br from-purple-500/20 to-indigo-600/10 border border-purple-500/40 text-purple-400 shadow-lg shadow-purple-500/15">
          <Shield className="w-7 h-7 text-purple-400" />
        </div>
        <div>
          <div className="flex items-center gap-2.5">
            <h1 className="font-cyber text-2xl font-extrabold tracking-tight text-white">
              A.E.G.I.S. <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-fuchsia-400 to-indigo-300">CYBER OPS</span>
            </h1>
            <span className="badge-label bg-purple-950/80 border border-purple-500/40 text-purple-300">
              PHANTOM AI v4.9
            </span>
          </div>
      ...
      <div className="hidden xl:flex items-center gap-4">
        ...
        <div className="flex items-center gap-4 px-3.5 py-2 rounded-xl bg-slate-900/90 border border-slate-800 shadow-inner">
          ...
          <div className="flex items-center gap-2 text-xs font-mono">
            ...
            <span className="px-2 py-0.5 rounded-full bg-purple-500/20 text-purple-300 font-bold border border-purple-500/40 text-[11px]">
              LEVEL 3 ELEVATED
            </span>
          </div>
        </div>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-purple-600/30 to-indigo-700/30 hover:from-purple-600/40 hover:to-indigo-700/40 border border-purple-500/40 text-purple-200 text-xs font-semibold transition-all active:scale-95 shadow-md shadow-purple-500/15"
        ...
        <button
          ...
          className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/40 text-purple-300 text-xs font-semibold transition-all active:scale-95 shadow-md shadow-purple-500/10"
        ...
        >
          {soundEnabled ? <Volume2 className="w-4.5 h-4.5 text-purple-400" /> : <VolumeX className="w-4.5 h-4.5 text-slate-500" />}
        </button>
