      ...
      <div className="relative w-full h-[320px] bg-slate-950/90 rounded-xl border border-slate-800 overflow-hidden flex items-center justify-center shadow-inner">
        ...
        {defaultNodes.map((node, idx) => (
          ...
          >
            ...
            {/* Tooltip on Hover */}
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 hidden group-hover:block z-30 w-52 p-3 rounded-xl bg-slate-900/95 border border-blue-500/40 text-xs font-sans text-slate-200 shadow-2xl backdrop-blur-md pointer-events-none">
              ...
              <div className="text-blue-300 mt-1 font-medium">{node.type}</div>
        ...
        >
          <div className="relative flex items-center justify-center">
            <div className="w-10 h-10 rounded-full bg-blue-500/25 border-2 border-blue-500 animate-pulse shadow-lg shadow-blue-500/50"></div>
            <div className="absolute w-5 h-5 rounded-full bg-blue-500 flex items-center justify-center text-white">
              <ShieldCheck className="w-3.5 h-3.5 text-white font-bold" />
            </div>
          </div>
          <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1.5 text-[11px] font-mono font-bold text-blue-200 whitespace-nowrap bg-slate-950/90 px-2.5 py-1 rounded-full border border-blue-500/40 shadow-lg">
            {socTarget.name}
          </div>
        </div>
      </div>
